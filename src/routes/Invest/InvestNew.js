...
import styles from './InvestNew.less';
...
export default class InvestNew extends Component {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="新的投资">
        <Card bordered={false}>
          <DescriptionList size="large" title="投资合同" style={{ marginBottom: 32 }}>
